...
class RateLimitException extends AppException {
  ...
  RateLimitException({
    ...
    Map<String, dynamic>? context,
          ...
          message: message ?? ExceptionConstants.defaultRateLimitError,
          userMessage: userMessage ?? ExceptionConstants.userFriendlyRateLimitError,
          errorCode: ExceptionConstants.rateLimitErrorCode,
          severity: ExceptionSeverity.high,
          prefix: ExceptionConstants.rateLimitErrorPrefix,
          context: {
            ...?context,
