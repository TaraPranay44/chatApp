...
class _$VerifyOtpRequestImpl implements _VerifyOtpRequest {
  const _$VerifyOtpRequestImpl({this.phone, this.email, this.code});
  ...
  @override
  String toString() {
    return 'VerifyOtpRequest(phone: $phone, email: $email, code: $code)';
  }
...
abstract class _VerifyOtpRequest implements VerifyOtpRequest {
  const factory _VerifyOtpRequest(
      {final String? phone,
      final String? email,
      final String? code}) = _$VerifyOtpRequestImpl;
